...
save_path="/cephfs/jianyu/real_data_v9_result"
...
python -m torch.distributed.launch --nproc_per_node=1 /cephfs/jianyu/mtcaseval/CasStereoNet/main.py --dataset kitti \
    --datapath /cephfs/datasets/iccv_pnp/messy-table-dataset/v9/training --trainlist /cephfs/datasets/iccv_pnp/messy-table-dataset/v9/training_lists/all_train.txt --testlist /cephfs/datasets/iccv_pnp/real_data_v9/test_list.txt \
    ...
    --model gwcnet-c --logdir "/cephfs/jianyu/real_data_v9_result"  --ndisps "48,24" \
